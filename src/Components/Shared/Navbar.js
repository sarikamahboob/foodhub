      ...
      <div class="navbar  max-w-7xl mx-auto">
        <div class="navbar-start">
          <div class="dropdown">
            ...
            <ul
              tabIndex="0"
              class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-orange-200 rounded-box w-52"
            >
              <li className="">
                <NavLink className="font-bold bg-orange-500 mb-2" to="/">
                  Home
                </NavLink>
              </li>
              ...
              <li>
                {user ? (
                  <button onClick={logout} className="btn bg-orange-500">
                    Sign Out
                  </button>
                ) : (
                  <Link to="/signin" className="font-bold bg-orange-500">
                    Sign In
                  </Link>
                )}
              </li>
        ...
        <div class="navbar-end hidden lg:flex">
          <ul class="menu menu-horizontal p-0 font-roboto">
            ...
            <li className="hover:bg-none">
              {user ? (
                <div>
                  <p className=" font-bold  ml-2 text-lg">{user.displayName}</p>
                  <button
                    onClick={logout}
